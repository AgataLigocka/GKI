...
public class SubroutineHierarchy extends JPanel {
	...
	private final static int WIDTH = 1000;   // The preferred size for the drawing area.
	private final static int HEIGHT = 700;

	private final static double X_LEFT = -5;    // The xy limits for the coordinate system.
	private final static double X_RIGHT = 5;
	private final static double Y_BOTTOM = -4;
	private final static double Y_TOP = 4;
	...
	private void scene(Graphics2D g2) { // (DELETE THIS EXAMPLE)
        ...
        g2.translate(0.3, -1); //poly1
        g2.rotate( Math.toRadians( frameNumber*0.7 ));
        ...
        g2.setColor(Color.RED); //line
        g2.setStroke(new BasicStroke((float) 0.25));
        g2.draw( new Line2D.Double( 0.3, -1, 	3.2, -1.3	) );
        g2.setTransform(saveTransform);
        
        g2.translate(1.75, -3.5); //triangle
...
// mid
        ...
        g2.translate(-3, 2.3); //poly1
        g2.rotate( Math.toRadians( frameNumber*0.7 ));
        g2.setColor( Color.BLACK );
        g2.scale( 0.008, 0.008 );
        g2.fill(polygon);
        g2.setColor(saveColor);
        g2.setTransform(saveTransform);
        
        g2.translate(-0.5, 2); //poly2
        g2.rotate( Math.toRadians( frameNumber*0.7 ));
        g2.setColor( Color.BLACK );
        g2.scale( 0.008, 0.008 );
        g2.fill(polygon);
        ...
        g2.draw( new Line2D.Double( -3, 2.3, 	-0.5, 2	) );
        g2.setTransform(saveTransform);
        
        g2.translate(-1.75, 0.2); //triangle
        g2.setColor(Color.BLUE);
        g2.scale( 0.8, 1 );
        filledTriangle2(g2);
        g2.setTransform(saveTransform);
...
// small
        ...
        g2.translate(2, 2.5); //poly1
        g2.rotate( Math.toRadians( frameNumber*0.7 ));
        g2.setColor( Color.BLACK );
        g2.scale( 0.006, 0.006 );
        g2.fill(polygon);
        g2.setColor(saveColor);
        g2.setTransform(saveTransform);
        
        g2.translate(4, 2.35); //poly2
        g2.rotate( Math.toRadians( frameNumber*0.7 ));
        g2.setColor( Color.BLACK );
        g2.scale( 0.006, 0.006 );
        g2.fill(polygon);
        ...
        g2.setColor(Color.RED); //line
        g2.setStroke(new BasicStroke((float) 0.2));
        g2.draw( new Line2D.Double( 2, 2.5, 	4, 2.35	) );
        g2.setTransform(saveTransform);
        
        g2.translate(3, 0.8); //triangle
        g2.setColor(Color.BLUE);
        g2.scale( 0.6, 0.8 );
        filledTriangle2(g2);
        g2.setTransform(saveTransform);
	...
	private static void filledTriangle2(Graphics2D g2) { // width = 1, height = 1, center of base is at (0,0);
		Path2D path = new Path2D.Double();  
		path.moveTo(-0.5,0);
		path.lineTo(0.5,0);
		path.lineTo(0,2);
